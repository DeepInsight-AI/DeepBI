...
class AdGroupTools:
    ...
    def create_adGroup_api(self,adGroup_info,market):
        try:
            ...
            result = sponsored_brands.AdGroupsV4(credentials=credentials,
    ...
    def update_adGroup_api(self,adGroup_info):
        ...
        try:
            result = sponsored_brands.AdGroupsV3(credentials=my_credentials,
  ...
  "includeExtendedDataFields": True,
        ...
        try:
            ...
            result = None
        adGroupID = ""
        if result and result.payload["adGroups"][0]:
            defaultBid_old = result.payload["adGroups"][0]
...
# agt=AdGroupTools_SD()
# # 测试更新广告系列信息
# res = agt.get_adGroup_api('FR','183647768054445')
# print(type(res))
# print(res)
