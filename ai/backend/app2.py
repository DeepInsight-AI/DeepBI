...
from ai.backend.aidb.autopilot.autopilot_sqlserver_api import AutopilotSqlserver
...
class MainHandler(tornado.web.RequestHandler):
    ...
    async def process_data(self, data):
        ...
        elif "sqlserver" == databases_type:
            autopilot_sqlserver = AutopilotSqlserver(chat_class)
            # new db
            await autopilot_sqlserver.deal_question(json_str)
        else:
