...
from bi import settings, rq_redis_connection, statsd_client
from bi.tasks import (
    sync_user_details,
    refresh_queries,
    remove_ghost_locks,
    empty_schedules,
...
class StatsdRecordingScheduler(Scheduler):
    """
    RQ Scheduler Mixin that uses Bi's custom RQ Queue class to increment/modify metrics via Statsd
    """
