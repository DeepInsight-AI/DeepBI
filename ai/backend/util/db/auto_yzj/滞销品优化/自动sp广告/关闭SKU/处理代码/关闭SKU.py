...
def main(path, brand, cur_time, country, version=2):
    # 文件路径定义
    input_csv_path = r'C:\Users\admin\PycharmProjects\DeepBI\ai\backend\util\db\auto_yzj\滞销品优化\自动sp广告\关闭SKU\预处理.csv'
    ...
    for index, row in result_df.iterrows():
        api.create_sku_info(country, brand, '滞销品优化', '自动_关闭', row['campaignName'], row['adGroupName'],
