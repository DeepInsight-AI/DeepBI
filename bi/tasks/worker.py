...
class BiQueue(StatsdRecordingQueue, CancellableQueue):
    pass
...
class HardLimitingWorker(HerokuWorker):
    ...
    in BI (if we don't respect them, workers may be infinitely stuck and as a result,
...
class BiWorker(StatsdRecordingWorker, HardLimitingWorker):
    queue_class = BiQueue
