...
def main(path, brand, cur_time, country):
    # 1. Load the data
    file_path = r'C:\Users\admin\PycharmProjects\DeepBI\ai\backend\util\db\auto_yzj\滞销品优化\手动sp广告\搜索词优化\预处理.csv'
    ...
    for index, row in result_df.iterrows():
        api.create_search_term_info(country, brand, '滞销品优化', '手动_劣质', row['campaignName'],row['campaignId'],
