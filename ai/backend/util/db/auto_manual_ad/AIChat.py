...
class AIChat:
    def __init__(self, input_path='', u_name='', db_id=0):
        api_key = '*****'
        api_host = "*****"
...
if __name__ == '__main__':
    ...
    #                                  R'\日常优化\张梦圆\手动sp广告关键词优化\预处理.csv')
    # q_str = md_to_str(
    #     R'C:\Users\33259\Desktop\DeepBI\ai\backend\util\db\auto_yzj\日常优化\张梦圆\手动sp广告关键词优化\提问策略\劣质关键词.md')
