...
from bi.utils import JSONEncoder, json_dumps, json_loads
    ...
    def configuration_schema(cls):
        return {
            ...
            "properties": {
                ...
                "password": {"type": "string", "title": "密码 Password"},
                "host": {"type": "string", "title": "服务器 Server", "default": "127.0.0.1"},
                "port": {"type": "number", "title": "端口 Port", "default": 5432},
                "dbname": {"type": "string", "title": "数据库 Database"},
                "sslmode": {
                    "type": "string",
                    "title": "SSL模式",
                    "default": "prefer",
                ...
                "sslrootcertFile": {"type": "string", "title": "根证书(SSL root certificate path)"},
                "sslcertFile": {"type": "string", "title": "客户端证书(SSL client certificate path)"},
                "sslkeyFile": {"type": "string", "title": "客户端密钥(SSL client certificate key)"},
            },
