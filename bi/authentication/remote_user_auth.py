...
def login(org_slug=None):
    ...
    if not settings.REMOTE_USER_LOGIN_ENABLED:
        ...
        return redirect(url_for("bi.index", next=next_path, org_slug=org_slug))
    ...
    return redirect(next_path or url_for("bi.index", org_slug=org_slug), code=302)
