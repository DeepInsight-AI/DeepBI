...
@app.route('/query')
def query():
    return render_template('query_test_outdoormaster.html')

# Create page - Render the create form
@app.route('/create')
def create():
    return render_template('create_test_outdoormaster.html')

@app.route('/modify')
def modify():
    return render_template('modify_test_outdoormaster.html')
...
if __name__ == '__main__':
    app.run(debug=False, host='0.0.0.0',port=4003, threaded=True)
