...
- When setting animation effects, you must use regular functions, and arrow functions are not allowed. In the function, the use of ternary expressions is not permitted.
