# filename: process_and_output_data_corrected.py
import pandas as pd
import numpy as np
...
# 输出结果到CSV文件
output_data = data[['date', 'keyword', 'keywordId', 'campaignName', 'adGroupName', 'matchType', 'keywordBid', 'targeting', 'total_cost_7d', 'total_clicks_7d', 'ACOS_7d', 'ACOS_30d', 'ORDER_1m', 'new_bid']]
output_data.columns = ['date', 'keyword', 'keywordId', 'campaignName', 'adGroupName', '匹配类型', '关键词出价', 'targeting', 'cost', 'clicks', '最近7天的平均ACOS值', '最近一个月的平均ACOS值', '最近一个月的订单数', '对该词进行提价多少以及提价原因']
