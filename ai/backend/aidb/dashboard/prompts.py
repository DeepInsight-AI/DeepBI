...
- You must follow the x-axis and y-axis defined in columnMapping to generate the corresponding data. If there are multiple y-axis data, you need to correspond to multiple y-axis data, and you cannot generate them arbitrarily. Moreover, the data must correspond one-to-one with the data in rows.
