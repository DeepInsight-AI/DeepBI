...
from bi.tasks.general import send_mail
from bi import redis_connection, settings, models
from bi.utils import json_dumps, json_loads, base_url, render_template
...
def send_failure_report(user_id):
    ...
    if errors:
        ...
        subject = "BI failed to execute {} of your scheduled queries".format(
