...
def main(path, brand, cur_time, country, version=2):
    ...
    file_name = "手动_劣质广告活动" + '_' + brand + '_' + country + '_' + cur_time + '.csv'
