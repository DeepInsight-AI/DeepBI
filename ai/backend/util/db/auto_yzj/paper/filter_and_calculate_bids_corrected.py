# filename: filter_and_calculate_bids_corrected.py
import pandas as pd
...
# 输出结果到CSV文件
output_data = data[['date', 'keyword', 'keywordId', 'campaignName', 'adGroupName', 'matchType', 'keywordBid', 'targeting', 'total_cost_7d', 'total_clicks_7d', 'ACOS_7d', 'ACOS_30d', 'ORDER_1m', 'new_bid', 'reason']]
