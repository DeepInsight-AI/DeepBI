# filename: 优质广告位_FR_2024-5-27.py
...
# 保存结果到CSV
result_df.to_csv(r'C:\Users\admin\PycharmProjects\DeepBI\ai\backend\util\db\auto_yzj\日常优化\手动sp广告\广告位优化\提问策略\优质广告位_FR_2024-5-27.csv', index=False)
