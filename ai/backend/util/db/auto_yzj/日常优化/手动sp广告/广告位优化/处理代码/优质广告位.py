...
def main(path, brand, cur_time, country, version=2):
    ...
    for index, row in result_df.iterrows():
        api.create_campaign_placement_info(country,brand,'日常优化','手动_优质',row['campaignName'],row['campaignId'],row['placementClassification'],row['bid'],row['new_bid'],row['ACOS_7d'],None,None,row['ACOS_3d'],row['total_sales14d_3d'],row['total_cost_3d'],row['reason'],cur_time,datetime.now(),0)
