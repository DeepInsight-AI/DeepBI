...
class CampaignTools:
    ...
    def list_campaigns_api(self,campaignId,market):
        ...
        try:
            ...
            result = sponsored_brands.CampaignsV4(credentials=credentials,
    ...
    def update_campaigns(self,campaign_info):
        ...
        try:
            result = sponsored_brands.CampaignsV4(credentials=my_credentials,
...
ct=CampaignTools()
#测试更新广告系列信息
res = ct.list_campaigns_api(68516439775720,'FR')
# #print(type(res))
# print(res)
