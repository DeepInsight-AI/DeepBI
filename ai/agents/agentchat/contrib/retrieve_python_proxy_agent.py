...
from ai.agents.code_utils import extract_code
...
class RetrievePythonProxyAgent(PythonProxyAgent):
    def __init__(
        self,
        name="RetrievePythonProxyAgent",  # default set to RetrieveChatAgent
