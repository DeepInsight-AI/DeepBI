...
from ...util.db.db_amazon.amazon_mysql_rag_util_sp import AmazonMysqlRagUitl
...
class AutopilotMysql(Autopilot):
 ...
 # async def start_chatgroup(self, json, report_file_name, report_id, q_name):
 #        schema = json
 #        report_html_code = {}
 #        try:
 #            report_html_code['report_name'] = q_name
...
def set_function_call_Amazon(self, db_info):

    mazonMysqlRagUitl = AmazonMysqlRagUitl(db_info=db_info)
    self.function_map = {
        "get_sp_searchterm_keyword_info": mazonMysqlRagUitl.get_sp_searchterm_keyword_info,
        # "get_total_daily_cost_rate": mazonMysqlRagUitl.get_total_daily_cost_rate,
        # "get_total_daily_profit_rate": mazonMysqlRagUitl.get_total_daily_profit_rate,
        # "get_total_daily_income": mazonMysqlRagUitl.get_total_daily_income,
        # "get_total_monthly_cost": mazonMysqlRagUitl.get_total_monthly_cost,
        # "get_total_monthly_cost_rate": mazonMysqlRagUitl.get_total_monthly_cost_rate,
        # "get_total_monthly_income": mazonMysqlRagUitl.get_total_monthly_income,
        # "get_total_monthly_profit_rate": mazonMysqlRagUitl.get_total_monthly_profit_rate,
        "base_question": self.base_question,
    }

    self.function_config = [
        {
            "name": "get_sp_searchterm_keyword_info",
            "description": "在一段时间内，某市场的SP广告的 平均ACOS ，总广告消耗，去重后用户搜索关键词 数量 和 总点击量 分别是多少？",
            "parameters": {
                "type": "object",
                "properties": {
                    "market": {
                    ...
                    "startdate": {
                        "type": "string",
                        "description": "The start time of this query.date of one day，like '1999-01-01'",
                    },
                    "enddate": {
                        "type": "string",
                        "description": "The end time of this query.date of one day，like '1999-01-01'",
                    }
                },
    ...
    return mazonMysqlRagUitl

async def total_question(self, qustion_message, db_info):

    mazonMysqlRagUitl = self.set_function_call_Amazon(db_info=db_info)
    ...
    # 关闭数据库链接
    mazonMysqlRagUitl.connect_close()
