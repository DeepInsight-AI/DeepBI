...
if os.environ.get("DEEPBI_SAML_LOCAL_METADATA_PATH") is not None:
...
PASSWORD_LOGIN_ENABLED = parse_boolean(
    os.environ.get("DEEPBI_PASSWORD_LOGIN_ENABLED", "true")
)

SAML_LOGIN_TYPE = os.environ.get("DEEPBI_SAML_AUTH_TYPE", "")
SAML_METADATA_URL = os.environ.get("DEEPBI_SAML_METADATA_URL", "")
SAML_ENTITY_ID = os.environ.get("DEEPBI_SAML_ENTITY_ID", "")
SAML_NAMEID_FORMAT = os.environ.get("DEEPBI_SAML_NAMEID_FORMAT", "")
SAML_SSO_URL = os.environ.get("DEEPBI_SAML_SSO_URL", "")
SAML_X509_CERT = os.environ.get("DEEPBI_SAML_X509_CERT", "")
SAML_SP_SETTINGS = os.environ.get("DEEPBI_SAML_SP_SETTINGS", "")
if SAML_LOGIN_TYPE == "static":
    SAML_LOGIN_ENABLED = SAML_SSO_URL != "" and SAML_METADATA_URL != ""
else:
    SAML_LOGIN_ENABLED = SAML_METADATA_URL != ""

DATE_FORMAT = os.environ.get("DEEPBI_DATE_FORMAT", "DD/MM/YY")
TIME_FORMAT = os.environ.get("DEEPBI_TIME_FORMAT", "HH:mm")
INTEGER_FORMAT = os.environ.get("DEEPBI_INTEGER_FORMAT", "0,0")
FLOAT_FORMAT = os.environ.get("DEEPBI_FLOAT_FORMAT", "0,0.00")
MULTI_BYTE_SEARCH_ENABLED = parse_boolean(
    os.environ.get("MULTI_BYTE_SEARCH_ENABLED", "false")
)

JWT_LOGIN_ENABLED = parse_boolean(os.environ.get("DEEPBI_JWT_LOGIN_ENABLED", "false"))
JWT_AUTH_ISSUER = os.environ.get("DEEPBI_JWT_AUTH_ISSUER", "")
JWT_AUTH_PUBLIC_CERTS_URL = os.environ.get("DEEPBI_JWT_AUTH_PUBLIC_CERTS_URL", "")
JWT_AUTH_AUDIENCE = os.environ.get("DEEPBI_JWT_AUTH_AUDIENCE", "")
JWT_AUTH_ALGORITHMS = os.environ.get(
    "DEEPBI_JWT_AUTH_ALGORITHMS", "HS256,RS256,ES256"
).split(",")
JWT_AUTH_COOKIE_NAME = os.environ.get("DEEPBI_JWT_AUTH_COOKIE_NAME", "")
JWT_AUTH_HEADER_NAME = os.environ.get("DEEPBI_JWT_AUTH_HEADER_NAME", "")

FEATURE_SHOW_PERMISSIONS_CONTROL = parse_boolean(
    os.environ.get("DEEPBI_FEATURE_SHOW_PERMISSIONS_CONTROL", "false")
)
SEND_EMAIL_ON_FAILED_SCHEDULED_QUERIES = parse_boolean(
    os.environ.get("DEEPBI_SEND_EMAIL_ON_FAILED_SCHEDULED_QUERIES", "false")
)
HIDE_PLOTLY_MODE_BAR = parse_boolean(os.environ.get("HIDE_PLOTLY_MODE_BAR", "false"))
DISABLE_PUBLIC_URLS = parse_boolean(
    os.environ.get("DEEPBI_DISABLE_PUBLIC_URLS", "false")
)
