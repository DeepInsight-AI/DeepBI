...
def1['reason'] = "Definition 1"

# Apply Definition 2
def2 = data[(data['ORDER_1m'] >= 2) & (data['ACOS_30d'] < 0.24)]
def2['reason'] = "Definition 2"
...
output_file_path = r"C:\Users\admin\PycharmProjects\DeepBI\ai\backend\util\db\auto_yzj\日常优化\手动sp广告\搜索词优化\提问策略\手动_优质搜索词_v1_1_ES_2024-06-18.csv"
