# filename: detect_acos_anomalies_v2.py
import pandas as pd
...
def main():
    ...
    try:
        ...
        output_file_path = r'C:\Users\admin\PycharmProjects\DeepBI\ai\backend\util\db\auto_yzj\日常优化\异常定位检测\广告活动\提问策略\异常检测_广告活动_ACOS异常_v1_0_LAPASA_US_2024-07-14.csv'
