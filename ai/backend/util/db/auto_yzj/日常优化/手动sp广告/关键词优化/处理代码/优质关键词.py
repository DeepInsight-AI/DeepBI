...
def get_raise_amount(row, version=3):
    ...
    if version == 1:
        if 0 < ACOS_7d <= 0.1 and 0 < ACOS_30d <= 0.1 and orders_1m >= 2:
            return 0.05, '定义一'
        elif 0 < ACOS_7d <= 0.1 < ACOS_30d <= 0.24 and orders_1m >= 2:
            return 0.03, '定义二'
        elif 0.2 >= ACOS_7d > 0.1 >= ACOS_30d > 0 and orders_1m >= 2:
            return 0.04, '定义三'
        ...
        if 0 < ACOS_3d <= 0.2 and 0 < ACOS_7d <= 0.1 and 0 < ACOS_30d <= 0.1 and orders_1m >= 2:
            return 0.05, '定义一'
        elif 0 < ACOS_3d <= 0.2 and 0 < ACOS_7d <= 0.1 < ACOS_30d <= 0.24 and orders_1m >= 2:
            return 0.03, '定义二'
        elif 0 < ACOS_3d <= 0.2 and 0.2 >= ACOS_7d > 0.1 >= ACOS_30d > 0 and orders_1m >= 2:
            return 0.04, '定义三'
        elif 0 < ACOS_3d <= 0.2 and 0.1 < ACOS_7d <= 0.2 and 0.1 < ACOS_30d <= 0.24 and orders_1m >= 2:
            return 0.02, '定义四'
        elif 0 < ACOS_3d <= 0.2 < ACOS_7d <= 0.24 and 0 < ACOS_30d <= 0.1 and orders_1m >= 2:
            return 0.02, '定义五'
        elif 0 < ACOS_3d <= 0.2 < ACOS_7d <= 0.24 and 0.1 < ACOS_30d <= 0.24 and orders_1m >= 2:
            return 0.01, '定义六'
        else:
            return 0, ''
    elif version == 3:
