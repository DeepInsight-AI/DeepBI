# filename: process_ads_budget_fixed.py
...
].copy()  # 使用copy()来避免SettingWithCopyWarning
...
# 添加原因列
filtered_df = filtered_df.assign(Reason='Good performance: ACOS_7d < 0.24, ACOS_yesterday < 0.24, cost_yesterday > 0.8 * Budget')
