...
function DashboardsPrettify() {
  ...
  const pre_btn = () => {
    return (
      <button className="dashbord_button" onClick={handleClick}>
        {" "}
        <span class="text">
          <strong>大屏美化</strong>
          <svg
  ...
  return (
    <div className="page-queries-list">
      ...
      <div className="container">
        <PageHeader title={window.W_L.dashboards_prettify_all} />
        <Layout>
          <Layout.Content>
            <React.Fragment>
              <div className="bg-white tiled table-responsive">
                <Table
                  ...
                  loading={isLoading}
                  locale={{
                    emptyText: <EmptyState className="" />,
                  }}
                />
              </div>
            </React.Fragment>
